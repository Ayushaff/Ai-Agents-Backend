...
class Account(UserMixin, Base):
    ...
    # coin_balance = db.Column(db.Integer, nullable=False, server_default=db.text("0"))
    # tokens_consumed = db.Column(db.Integer, nullable=False, server_default=db.text("0"))
    # payload_role = db.Column(db.String(255), nullable=True)
    
    # # Store complex Payload data as JSON
    # payload_profile = db.Column(JSONB, nullable=True)  # For genInfo, socialMediaLinks, etc.
    # payload_relationships = db.Column(JSONB, nullable=True)  # For products, purchases, etc.
    # payload_social = db.Column(JSONB, nullable=True)  # For likes, following, followers
    
    # # Simple fields
    # user_type = db.Column(db.String(255), nullable=True)
    # over_18 = db.Column(db.Boolean, nullable=False, server_default=db.text("true"))
    # domain = db.Column(db.String(255), nullable=True)
    # create_rapp_permission = db.Column(db.Boolean, nullable=False, server_default=db.text("false"))
